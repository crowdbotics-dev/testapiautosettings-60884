...
## Project Structure
    ...
    ├── testapiautosettings_60884  # Django project configurations
...
1. Clone this repo and `cd testapiautosettings_60884`
...
2. Clone this repo and `cd testapiautosettings_60884`
